    ...
    <section className="border-t border-hairline bg-background">
      <div className="mx-auto w-full max-w-[1600px] px-6 md:px-10">
        <div className="grid grid-cols-1 border-x border-hairline lg:grid-cols-12">
          <div className="relative border-b border-hairline p-8 lg:col-span-5 lg:border-b-0 lg:border-e lg:p-12">
          ...
          <ul className="lg:col-span-7">
            {t.clients.list.map((c, i) => (
              <Reveal
                ...
                key={c.name}
                delay={i * 40}
                className="group flex items-baseline justify-between gap-6 border-b border-hairline px-8 py-6 transition-colors duration-300 hover:bg-secondary lg:px-12"
              >
    ...
    <section className="bg-background">
      <div className="mx-auto w-full max-w-[1600px] px-6 md:px-10">
        <div className="grid grid-cols-1 border-x border-t border-hairline lg:grid-cols-12">
          <Reveal className="border-b border-hairline p-8 lg:col-span-5 lg:border-b-0 lg:border-e lg:p-12">
          ...
          <ul className="lg:col-span-7">
            {t.awards.items.map((a, i) => (
              <Reveal
                ...
                key={a.name}
                delay={i * 60}
                className="flex flex-wrap items-baseline justify-between gap-4 border-b border-hairline px-8 py-7 lg:px-12"
              >
        ...
        <Reveal className="border-x border-hairline px-8 py-16 lg:px-12">
        ...
        <ul className="grid grid-cols-1 border-x border-t border-hairline md:grid-cols-3">
          {t.awards.stories.map((s, i) => (
            <Reveal
              ...
              key={s.title}
              delay={i * 70}
              className="group relative border-b border-hairline p-8 transition-colors duration-300 hover:bg-secondary md:[&:not(:last-child)]:border-e"
            >
              <PlusMark className="-end-[6px] -top-[6px] text-muted-foreground" />
        ...
        <Reveal className="flex justify-center border-x border-b border-hairline px-8 py-14">
...
function FaqRow({ index, question, answer }: { index: number; question: string; answer: string }) {
  ...
  return (
    <details className="group border-b border-hairline">
      <summary
        className="flex cursor-pointer list-none items-center justify-between gap-8 px-8 py-7 transition-colors duration-300 hover:bg-secondary lg:px-12 [&::-webkit-details-marker]:hidden"
        aria-controls={id}
      >
      ...
      <div
        id={id}
        className="grid grid-rows-[1fr] px-8 pb-8 ps-8 text-sm leading-relaxed text-muted-foreground lg:px-12 lg:ps-[7.5rem]"
      >
